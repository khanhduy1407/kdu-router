...
// 4. Create extended base Kdu with router injected here (all
// children should inherit the same router).
const BaseVue = Vue.extend({ router })

// Discrete components means that a new Kdu instance will be created
// and bound on multiple *independent* nodes (eg. one Kdu instance
