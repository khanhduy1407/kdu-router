...
We can also use [route meta fields](meta.md) to implement fine-grained scroll behavior control. Check out a full example [here](https://github.com/khanhduy1407/kdu-router/blob/dev/examples/scroll-behavior/app.js).
